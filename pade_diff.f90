...
! Local:
real(8) :: q, r, s, alpha_hat, numer, denom, a3, b3
integer :: ir, iz, i

! Go over to Lele's notation:
q = b1
r = c1
s = d1
...
!!$        access = 'append')
!!$   write(lun_info, "('Quadrature weights for conservative Pade')")
!!$   do i = 1, 4
!!$      write(lun_info, 1) i, w_final(i)
...
! Differentiator for the z-direction. USED.
