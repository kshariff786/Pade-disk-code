...
if (my_node .eq. 0) then
   ...
   write(lun_info, *) ' in set_up_Cassen_Moosman_infall'
   write(lun_info, *) ' M0_dot = ', M0_dot/(Msolar/year), ' Msol/yr'
   write(lun_info, *) ' rd/AU = ', rd/AU
   write(lun_info, *) ' Mstar/Msolar = ', Mstar/Msolar
   write(lun_info, *) ' c0 = ', c0/100.d0, 'm s^-1'
   write(lun_info, *) ' infall_forcing = ', infall_forcing
   write(lun_info, *) ' vel_forcing_amplitude = ', vel_forcing_amplitude, ' cm/s'
   close (lun_info)
end if
