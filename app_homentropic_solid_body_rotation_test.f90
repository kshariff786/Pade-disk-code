...
subroutine homentropic_solid_body_rotation_test
...
real(8) :: rmin_BC, rmax_BC, zmin_BC, zmax_BC, ibalanced
...
do istep = 1, nsteps
   ! call euler (q, cfl, t)
   call rk4(rhs, q, cfl, t, dt, use_supplied_dt)
...
end subroutine homentropic_solid_body_rotation_test
...
energy   = pressure/gm1 + 0.5d0 * rho * uphi**2
