...
! Smooths the q field in all three directions.
...
if (my_node .eq. 0) then
   print *, ' filter_relative_to_basic_state = ', filter_relative_to_basic_state
   print *, ' eps_filter_now = ', eps_filter_now
end if

if (filter_relative_to_basic_state) then
   do iz = 1, nz
      do iphi = sphi, ephi
         do ir = sr, er
...
#endif   
   call smooth_periodic(mr*mz_phi*nvar, mr*mz_phi*ndof, nphi, q_phi_space, Q_filter)
#ifdef debug_print
