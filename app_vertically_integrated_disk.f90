...
namelist /vid_input/ restart, file_version, nr, nphi, nz, cfl, nsteps, tecplot_interval, &
...
call tecplot_vort_and_dil(q, t, plot_perturbation_field1, plot_vorticity_over_rho1, plot_curl_rho_u, 'style1')
call tecplot_vort_and_dil(q, t, plot_perturbation_field2, plot_vorticity_over_rho2, plot_curl_rho_u, 'style2')
...
do istep = istep1, istep1 + nsteps - 1
   ...
   ! remove later
   print *, ' use_supplied_dt = ', use_supplied_dt
   print *, ' cfl = ', cfl
