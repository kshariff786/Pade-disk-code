...
subroutine vortex_pair  ! Vortex pair in vertically integrated disk.
...
! For passing to subroutine initialize.
...
vortex_type = 'Gaussian' !'Seligman' ! 'Gaussian'
pi = 4.0d0 * atan(1.0d0)
