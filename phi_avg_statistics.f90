...
! TOOLS/phi_time_Favre_averages.f90.  See notes of 11/24/20 for the algebra on how to
...
subroutine output_rms(t, uz_rms, ur_rms, uphi_rms, output_profiles)
...
subroutine write_ave_fluctuation_ke(t)
...
end subroutine write_ave_fluctuation_ke
