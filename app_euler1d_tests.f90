...
subroutine euler1d_tests

! Defined in the rest of code.
use activate_routines
use problem_type_module
use logical_units
use boundary_condition_types  
use q_array, only: q
use thermal_parameters, only: ci_squared_initial  ! Needed for isothermal = .true.
...
do i_output_step = 1, n_output_steps
   do while (.not. target_met)
      call rk4_with_target(rhs, q, cfl, t, dt, use_supplied_dt, negative_density, &
