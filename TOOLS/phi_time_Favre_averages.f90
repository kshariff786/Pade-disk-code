...
read(lun_input, *)
read(lun_input, *) nfiles, nr, nz
print *, ' nfiles to process = ', nfiles, ' nr = ', nr, ' nz = ', nz
...
read(lun_grid, "(i6, i6)") nr_in_grid, nz_in_grid
if (nr_in_grid .ne. nr) then
   print *, ' nr_in_grid = ', nr_in_grid
   print *, ' nr         = ', nr
   print *, ' The two do not match'
   stop
end if

if (nz_in_grid .ne. nz) then
   print *, ' nz_in_grid = ', nz_in_grid
   print *, ' nz         = ', nz
   print *, ' The two do not match'
   stop
end if
